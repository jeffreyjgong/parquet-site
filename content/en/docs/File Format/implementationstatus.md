...
| Data type                                 | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino | spark |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- | ----- |
| BOOLEAN                                   |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |       |
| INT32                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |       |
| INT64                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |       |
...
| Encoding                                  | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino | spark |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- | ----- |
| PLAIN                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |       |
| PLAIN_DICTIONARY                          |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  (R)   |            |       |       |
| RLE_DICTIONARY                            |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |       |
...
| Compression                               | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino | spark |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- | ----- |
| UNCOMPRESSED                              |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |       |
| BROTLI                                    |  ✅   |  ✅           |  ✅      |  ✅      |  (R)  |  (R)      |   ✅   |            |       |       |
| GZIP                                      |  ✅   |  ✅           |  ✅      |  ✅      |  (R)  |  (R)      |   ✅   |            |       |       |
...
| Feature                         | arrow | parquet-java  | arrow-go | arrow-rs | cudf | hyparquet | duckdb | databricks | trino | spark |
|---------------------------------| ----- | ------------- | -------- | -------- | ---- | --------- | ------ | ---------- | ----- | ----- |
