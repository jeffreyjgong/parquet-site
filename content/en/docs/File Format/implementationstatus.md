...
| Data type                                 | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- |
| BOOLEAN                                   |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |
| INT32                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |
| INT64                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |
...
| Encoding                                  | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- |
| PLAIN                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |
| PLAIN_DICTIONARY                          |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  (R)   |            |       |
| RLE_DICTIONARY                            |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |
...
| Compression                               | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- |
| UNCOMPRESSED                              |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |
| BROTLI                                    |  ✅   |  ✅           |  ✅      |  ✅      |  (R)  |  (R)      |   ✅   |            |       |
| GZIP                                      |  ✅   |  ✅           |  ✅      |  ✅      |  (R)  |  (R)      |   ✅   |            |       |
...
| Feature                         | arrow | parquet-java  | arrow-go | arrow-rs | cudf | hyparquet | duckdb | databricks | trino |
|---------------------------------| ----- | ------------- | -------- | -------- | ---- | --------- | ------ | ---------- | ----- |
