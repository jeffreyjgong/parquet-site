...
| Data type                                 | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino | spark | iceberg-spark |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- | ----- | ------------- |
| BOOLEAN                                   |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |       |               |
| INT32                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |       |               |
| INT64                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  ✅   |            |       |       |               |
...
| Encoding                                  | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino | spark | iceberg-spark |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- | ----- | ------------- |
| PLAIN                                     |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |       |               |
| PLAIN_DICTIONARY                          |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |  (R)   |            |       |       |               |
| RLE_DICTIONARY                            |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |       |               |
...
| Compression                               | arrow | parquet-java  | arrow-go | arrow-rs | cudf  | hyparquet | duckdb | databricks | trino | spark | iceberg-spark |
| ----------------------------------------- | ----- | ------------- | -------- | -------- | ----- | --------- | ------ | ---------- | ----- | ----- | ------------- |
| UNCOMPRESSED                              |  ✅   |  ✅           |  ✅      |  ✅      |  ✅   |  ✅       |   ✅   |            |       |       |               |
| BROTLI                                    |  ✅   |  ✅           |  ✅      |  ✅      |  (R)  |  (R)      |   ✅   |            |       |       |               |
| GZIP                                      |  ✅   |  ✅           |  ✅      |  ✅      |  (R)  |  (R)      |   ✅   |            |       |       |               |
...
| Feature                         | arrow | parquet-java  | arrow-go | arrow-rs | cudf | hyparquet | duckdb | databricks | trino | spark | iceberg-spark |
|---------------------------------| ----- | ------------- | -------- | -------- | ---- | --------- | ------ | ---------- | ----- | ----- | ------------- |
